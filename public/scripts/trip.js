...
function editTripDetails(thisTrip) {
  let notEditableImage = document.getElementById(`tripImage${thisTrip}`).getAttribute("src");
  ...
  document.getElementById("tripImageModal").value = notEditableImage;
...
saveBTN.addEventListener("click", async (e) => {
  e.preventDefault();
  let unEditableImage =document.getElementById("tripImageModal").value
